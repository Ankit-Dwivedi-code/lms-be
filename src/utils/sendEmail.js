      ...
      html: `
        <div style="font-family: 'Segoe UI', sans-serif; color: #f1f1f1; background-color: #0f0f1b; max-width: 600px; margin: auto; padding: 30px; border-radius: 12px; box-shadow: 0 0 15px #0ff;">
          ...
          <div style="text-align: center; margin-top: 30px;">
            <a href="https://www.neuronest.space/" style="display: inline-block; padding: 10px 20px; background-color: #00ffff; color: #000; text-decoration: none; border-radius: 5px; font-weight: bold;">Visit Website</a>
          </div>
        </div>
      `,
    });
